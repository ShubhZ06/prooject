...
"[project]/src/api/stockMovements.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$stockMovements$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/api/stockMovements.ts [app-ssr] (ecmascript)");
...
const MoveHistory = ()=>{
    ...
    const [movements, setMovements] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(mockMovements);
    ...
    const loadMovements = async ()=>{
        try {
            setLoading(true);
            setError(null);
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$stockMovements$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStockMovements"])();
            setMovements(data);
        } catch (err) {
    ...
    const handleDropInternal = async (id, newStatus)=>{
        try {
            const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$stockMovements$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateStockMovementStatus"])(id, newStatus);
...
//# sourceMappingURL=_bb1e596d._.js.map